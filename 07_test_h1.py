...
fig, axs = plt.subplots(2, len(times) + 1, figsize=(10, 6))
uVmax = 9
...
report.add_figure(fig=fig, title="Topomaps", image_format="PNG")
...
report.add_figure(fig=fig, title="Sensor overview", image_format="PNG")
# %%
...
report.add_figure(fig=fig, title="Timecourse fronto-central", image_format="PNG")
# %%
...
report.add_figure(fig=fig, title="Timecourse central", image_format="PNG")
...
report.add_figure(fig=fig, title="Timecourse parieto-occipital", image_format="PNG")
